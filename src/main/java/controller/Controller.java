...
public class Controller {
    ...
    @FXML
    TableView<CategVarsta> tabelCateg;
    @FXML
    TableColumn<CategVarsta, String> colCateg;
    @FXML
    TableView<Proba> tabelProbe;
    @FXML
    TableColumn<Proba, String> colProbe;
    @FXML
